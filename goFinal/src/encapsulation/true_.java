	...
	while(true){
		...
		if(totyou >=100){
			...
			if(rules[totyou-1]<totyou)
				System.out.println(rules[totyou-1]+"로 미끌어 집니다. 쿵!!");
			else 
				System.out.println(rules[totyou-1]+"로 올라갑니다. 슝!!");
		...
		if(totcom>=100){
			...
			if(rules[totcom-1]<totcom)
				System.out.println(rules[totcom-1]+"로 미끌어 집니다. 쿵!!");
			else 
				System.out.println(rules[totcom-1]+"로 올라갑니다. 슝!!");
